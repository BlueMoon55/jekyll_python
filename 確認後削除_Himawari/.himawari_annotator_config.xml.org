...
<setting>
  <annotator>
    ...
    <li name="MeCab(UniDic)" os="Windows" annotation="morph" command="C:\Program Files\MeCab\bin\mecab" option="--dicdir=resources\unidic --output-format-type= --node-format=%m\t%f[0]\t%f[1]\t%f[2]\t%f[3]\t%f[4]\t%f[5]\t%f[7]\t%f[8]\t%f[9]\n --unk-format=%m\t%f[0]\t%f[1]\t%f[2]\t%f[3]\t%f[4]\t%f[5]\t*\t*\t*\t*\t*\t*\n" encoding="utf-8">
      <extract element="" attribute="" value="" />
      <chunk delimitor="[。？！]+" maxlength="200" />
      <result_fields delimitor="\t">
	<li name="_TEXT" isCompleteMatch="false" />
